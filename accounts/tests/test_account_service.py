...
class AccountServiceTests(TestCase):
    ...
    def test_create_account(self):
        account = AccountService.create_account(self.user)
    ...
    def test_create_account_with_subscription_type(self):
        account = AccountService.create_account(self.user, subscription_type="premium")
        
        self.assertEqual(account.subscription_type, "premium")
        
    def test_create_account_duplicate(self):
        # Create first account
        AccountService.create_account(self.user)
    ...
    def test_get_account_by_user(self):
        created_account = AccountService.create_account(self.user)
        
        found_account = AccountService.get_account_by_user(self.user)
        self.assertEqual(created_account, found_account)
        
    def test_get_account_by_id(self):
        created_account = AccountService.create_account(self.user)
        
        found_account = AccountService.get_account_by_id(created_account.id)
        self.assertEqual(created_account, found_account)
        
    def test_update_subscription(self):
        account = AccountService.create_account(self.user)
        
        updated_account = AccountService.update_subscription(account, "premium")
    ...
    def test_update_subscription_invalid_type(self):
        ...
        with self.assertRaises(ValueError):
            AccountService.update_subscription(account, "invalid_type")
    ...
    def test_activate_account(self):
        ...
        activated_account = AccountService.activate_account(account)
    ...
    def test_deactivate_account(self):
        ...
        deactivated_account = AccountService.deactivate_account(account)
    ...
    def test_get_accounts_by_subscription(self):
        ...
        basic_account = AccountService.create_account(self.user, "basic")
        premium_account = AccountService.create_account(user1, "premium")
        enterprise_account = AccountService.create_account(user2, "enterprise")
        
        # Get accounts by subscription type
        basic_accounts = AccountService.get_accounts_by_subscription("basic")
        premium_accounts = AccountService.get_accounts_by_subscription("premium")
        enterprise_accounts = AccountService.get_accounts_by_subscription("enterprise")
